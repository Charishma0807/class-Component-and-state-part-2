...
class App extends Component {
  ...
  deleteUser = uniqueNo => {
    // console.log('Delete User Method Triggered.')
  ...
  render() {
    ...
    const searchUserResults = userDetailsList.filter(eachUser =>
    ...
    return (
      <div className="app-container">
        ...
        <ul className="list-container">
          {/* replacing userDetailsList to searchUserResults in map function */}
